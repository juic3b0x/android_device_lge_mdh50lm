...
DEVICE_PATH := device/lge/mdh50lm
...
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 androidboot.hardware=mdh50lm androidboot.usbconfigfs=true buildvariant=user
...
TARGET_KERNEL_CONFIG := mdh50lm_defconfig
TARGET_KERNEL_SOURCE := kernel/lge/mdh50lm
